...
public class LocalStorageProvider extends DocumentsProvider {
    ...
    public static final String AUTHORITY = "com.ivarprudnikov.sensors.documents";
    ...
    public Cursor queryRoots(final String[] projection) throws FileNotFoundException {
        ...
        row.add(Root.COLUMN_TITLE, getContext().getString(R.string.file_picker_internal_storage));
